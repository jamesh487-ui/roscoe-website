...
const workflowSections = [
  ...
  },
  {
    ...
    text: "Create professional quotes and invoices, send customer links, track acceptance and keep payment status connected to the job.",
  ...
  },
  {
    ...
    phonePosition: "-bottom-7 -right-1 sm:-right-4 lg:-right-8",
    bullets: [
      { label: "Message drafting", plan: "Starter+", text: "Create customer-facing message drafts faster, then review and send when ready." },
